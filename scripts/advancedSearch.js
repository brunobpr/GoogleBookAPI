function advancedForm() {
  //Unhide the advanced form if the checkbox is checked
...
//It is called from the submit button from the advanced form
//It will use the title a/or the author's name to search for a book
...
function getBook() {
  ...
  //If the user didnt entered an author, just add the title to the url
  if (authorInput == "") {
    url = 'https://www.googleapis.com/books/v1/volumes?q=+intitle:' + titleInput + '&key=AIzaSyCfxVfRWs5eLZEwwiZemvp1iAwyAaHBHUQ'
  }
  //If the user didnt entered an title, just add the author to the url
  else if (titleInput == "") {
